  ...
  return (
    <footer className="bg-white py-8 px-4 sm:px-6 lg:px-8 border-t border-gray-100">
      <div className="max-w-7xl mx-auto">
        {/* Desktop Layout (lg and above) - Two row layout matching the image */}
        <div className="hidden lg:block">
          {/* First row: Logo, Links, Social Media */}
          ...
          {/* Second row: Copyright and Email */}
        ...
        {/* Mobile/Tablet Layout (below lg) - Keep original design */}
