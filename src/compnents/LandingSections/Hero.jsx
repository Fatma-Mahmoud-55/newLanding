...
finc makes growing your money smart, easy and stress-free..
              ...
              <div className="animate-slide-in-left" style={{ animationDelay: '0.8s' }}>
                ...
                <p className="text-xs sm:text-sm text-gray-400 mt-4 animate-fade-in text-center md:text-start" style={{ animationDelay: '1s' }}>
Get early access. Limited spots. Your future’s waiting.
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-center items-center animate-slide-in-right h-full" style={{ animationDelay: '0.5s' }}>
              <div className="relative h-full lg:w-full md:w-[50%] w-[90%] !pb-0 flex items-end justify-center">
                <img 
                  src="/Mockup.png" 
