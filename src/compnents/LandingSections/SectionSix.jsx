...
export default function SectionSix() {
  return (
    <div className="relative">
      ...
      <div className="min-h-screen bg-white relative z-10 border-t border-white lg:rounded-t-[50px] md:rounded-t-[30px] rounded-t-[25px] flex items-center justify-center p-4 lg:p-8">
          ...
          <div className="relative gap-8 lg:gap-16 items-center">
            ...
            <div className="relative z-20 w-full">
              ...
              <div className="relative w-full">
                <div className="w-full bg-gradient-to-br from-purple-700 to-purple-400 rounded-3xl p-8 lg:p-10 text-white relative overflow-hidden">
